...
export const SAMPLE_USERS = {
  ...
  marcus:   makeSampleUser("sample-user-6",  "Marcus",   "Williams", "men/88",    { bio: "Advanced English, advanced mindset, let's talk!", decoration: "sleeping-cat" }),
  ...
  yuki:     makeSampleUser("sample-user-11", "Yuki",     "Tanaka",   "women/5",   { bio: "Anime lover learning English through stories", decoration: "fox-spirit" }),
...
export const SAMPLE_ROOMS: Room[] = [
  ...
  { id: "sample-room-6", title: "Japanese Practice 🇯🇵",     language: "Japanese", level: "Beginner",     maxUsers: 4, ownerId: SAMPLE_USERS.ryo.id,     isPublic: false, activeUsers: 4, roomTheme: "cherry",   hologramVideoUrl: "https://media.tenor.com/43y9MR-VUgUAAAAM/sakura.gif", createdAt: new Date() },
  ...
  { id: "sample-room-12", title: "Tokyo VIP 🇯🇵",             language: "Japanese", level: "Intermediate", maxUsers: 5, ownerId: SAMPLE_USERS.takeshi.id, isPublic: false, activeUsers: 5, roomTheme: "cherry", hologramVideoUrl: "https://media.tenor.com/SBwOJlD-haUAAAAM/cherry-blossom-sakura.gif", createdAt: new Date() },
...
export const BASE_SAMPLE_PARTICIPANTS: Record<string, User[]> = {
  ...
  "sample-room-6": [SAMPLE_USERS.ryo, SAMPLE_USERS.natasha, SAMPLE_USERS.kwame, SAMPLE_USERS.amara],
