...
export const SAMPLE_ROOMS: Room[] = [
  ...
  // ── Locked / premium rooms ────────────────────────────────────────────────
  { id: "sample-room-10", title: "Elite English Lounge 🔒",   language: "English",  level: "Advanced",     maxUsers: 5, ownerId: SAMPLE_USERS.james.id,   isPublic: false, activeUsers: 4, roomTheme: "neon",   hologramVideoUrl: null, createdAt: new Date() },
  { id: "sample-room-11", title: "Cercle Privé 🇫🇷",          language: "French",   level: "Advanced",     maxUsers: 4, ownerId: SAMPLE_USERS.claire.id,  isPublic: false, activeUsers: 3, roomTheme: "violet", hologramVideoUrl: null, createdAt: new Date() },
  { id: "sample-room-12", title: "Tokyo VIP 🇯🇵",             language: "Japanese", level: "Intermediate", maxUsers: 5, ownerId: SAMPLE_USERS.takeshi.id, isPublic: false, activeUsers: 5, roomTheme: "cherry", hologramVideoUrl: null, createdAt: new Date() },
  // ── Nature / Universe themed rooms ───────────────────────────────────────
  { id: "sample-room-13", title: "Aurora Borealis 🌌",        language: "English",  level: "Intermediate", maxUsers: 5, ownerId: SAMPLE_USERS.aigerim.id, isPublic: true,  activeUsers: 4, roomTheme: "galaxy", hologramVideoUrl: null, createdAt: new Date() },
  { id: "sample-room-14", title: "Ocean Waves 🌊",            language: "Spanish",  level: "Beginner",     maxUsers: 4, ownerId: SAMPLE_USERS.isabela.id, isPublic: true,  activeUsers: 3, roomTheme: "ocean",  hologramVideoUrl: null, createdAt: new Date() },
  { id: "sample-room-15", title: "Galaxy Talk 🚀",            language: "English",  level: "Advanced",     maxUsers: 5, ownerId: SAMPLE_USERS.kwame.id,   isPublic: true,  activeUsers: 5, roomTheme: "neon",   hologramVideoUrl: null, createdAt: new Date() },
  { id: "sample-room-16", title: "Enchanted Forest 🌿",       language: "German",   level: "Beginner",     maxUsers: 4, ownerId: SAMPLE_USERS.anya.id,    isPublic: true,  activeUsers: 3, roomTheme: "violet", hologramVideoUrl: null, createdAt: new Date() },
  { id: "sample-room-17", title: "Golden Sunset 🌅",          language: "Portuguese", level: "Beginner",   maxUsers: 4, ownerId: SAMPLE_USERS.lucas.id,   isPublic: true,  activeUsers: 4, roomTheme: "sunset", hologramVideoUrl: null, createdAt: new Date() },
  { id: "sample-room-18", title: "Tropical Vibes 🌺",         language: "Chinese",  level: "Beginner",     maxUsers: 5, ownerId: SAMPLE_USERS.mei.id,     isPublic: true,  activeUsers: 4, roomTheme: "cherry", hologramVideoUrl: null, createdAt: new Date() },
];
